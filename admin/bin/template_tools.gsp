...
uses gw.webservice.pc.pc1000.templatetoolsapi.TemplateToolsAPI
...
config.ServerOverrideUrl = new URL(TemplateToolsArgs.Server + "/ws/gw/webservice/pc/pc1000/TemplateToolsAPI").toURI() as String
