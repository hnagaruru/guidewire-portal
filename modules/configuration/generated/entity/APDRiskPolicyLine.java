...
public class APDRiskPolicyLine extends entity.APDRiskCoverable {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> APDEDITION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "APDEdition");
  ...
  public entity.APDProductLineEdition getAPDEdition() {
    return (entity.APDProductLineEdition)__getInternalInterface().getFieldValue(APDEDITION_PROP.get());
  }
  ...
  public void setAPDEdition(entity.APDProductLineEdition value) {
    __getInternalInterface().setFieldValue(APDEDITION_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDRiskPolicyLineInternal {
    ...
    public gw.pl.persistence.core.Key getAPDEditionID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(APDEDITION_PROP.get());
    }
    ...
    public void setAPDEditionID(gw.pl.persistence.core.Key value) {
      setFieldValue(APDEDITION_PROP.get(), value);
    }
