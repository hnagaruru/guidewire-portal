...
public class APDLoadXmindPopup extends com.guidewire.pl.web.codegen.LocationBase {
  static function createDestination () : pcf.api.Destination {
    return __newDestinationForLocation(pcf.APDLoadXmindPopup, {}, 3)
  }
  
  static function createDestination (existingVisualizedProduct :  APDProduct) : pcf.api.Destination {
    return __newDestinationForLocation(pcf.APDLoadXmindPopup, {existingVisualizedProduct}, 1)
  }
  ...
  static function createDestination (existingInstalledProduct :  gw.api.productmodel.Product) : pcf.api.Destination {
    return __newDestinationForLocation(pcf.APDLoadXmindPopup, {existingInstalledProduct}, 2)
  }
  
  static function push () : pcf.api.Location {
    return __newDestinationForLocation(pcf.APDLoadXmindPopup, {}, 3).push()
  }
  
  static function push (existingVisualizedProduct :  APDProduct) : pcf.api.Location {
    return __newDestinationForLocation(pcf.APDLoadXmindPopup, {existingVisualizedProduct}, 1).push()
  }
  ...
  static function push (existingInstalledProduct :  gw.api.productmodel.Product) : pcf.api.Location {
    return __newDestinationForLocation(pcf.APDLoadXmindPopup, {existingInstalledProduct}, 2).push()
  }
