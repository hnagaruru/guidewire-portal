...
class APDAttributeDefaultValue_booleanExpressions {
  ...
  public static class APDAttributeDefaultValueExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on BooleanRadioCell (id=value_Cell) at APDAttributeDefaultValue.boolean.pcf: line 32, column 58
    ...
    // 'initialValue' attribute on Variable at APDAttributeDefaultValue.boolean.pcf: line 27, column 32
    function initialValue_0 () : APDAttributeRule {
      return attribute.getEditionRule(edition, ruleType)
    }
    
    // 'value' attribute on BooleanRadioCell (id=value_Cell) at APDAttributeDefaultValue.boolean.pcf: line 32, column 58
    function value_4 () : java.lang.Boolean {
      return UIValue
    }
    
    // 'valueVisible' attribute on BooleanRadioCell (id=value_Cell) at APDAttributeDefaultValue.boolean.pcf: line 32, column 58
