...
class APDAttributeDefaultValue_calculatedExpressions {
  @javax.annotation.Generated("config/web/pcf/tools/apd/APDAttributeDefaultValue.calculated.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class APDAttributeDefaultValueExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on TextCell (id=value_Cell) at APDAttributeDefaultValue.calculated.pcf: line 31, column 67
    ...
    // 'initialValue' attribute on Variable at APDAttributeDefaultValue.calculated.pcf: line 27, column 32
