...
class APDAttributeDefaultValue_moneyExpressions {
  ...
  public static class APDAttributeDefaultValueExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on TextCell (id=value_Cell) at APDAttributeDefaultValue.money.pcf: line 33, column 41
    ...
    // 'initialValue' attribute on Variable at APDAttributeDefaultValue.money.pcf: line 27, column 32
    function initialValue_0 () : APDAttributeRule {
      return attribute.getEditionRule(edition, ruleType)
    }
    
    // 'value' attribute on TextCell (id=value_Cell) at APDAttributeDefaultValue.money.pcf: line 33, column 41
