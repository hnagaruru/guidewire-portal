...
class SideBySideCovTermInputSet_datetime_notargetExpressions {
  ...
  public static class SideBySideCovTermInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'colspan' attribute on LayoutConfig at SideBySideCovTermInputSet.datetime_notarget.pcf: line 54, column 97
    function colspan_14 () : java.lang.Integer {
      return colWidth
    }
    
    // 'def' attribute on InputSetRef at SideBySideCovTermInputSet.datetime_notarget.pcf: line 62, column 29
    ...
    // 'value' attribute on DateInput (id=SideBySideDateTimeCovTermValue_Input) at SideBySideCovTermInputSet.datetime_notarget.pcf: line 51, column 39
    function defaultSetter_21 (__VALUE_TO_SET :  java.lang.Object) : void {
      covTermInfo.DateValue = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on CheckBoxInput (id=covTermEnabledId_Input) at SideBySideCovTermInputSet.datetime_notarget.pcf: line 30, column 30
    function defaultSetter_6 (__VALUE_TO_SET :  java.lang.Object) : void {
      covTermInfo.CovInfo.Selected = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'disablePostOnEnter' attribute on PostOnChange at SideBySideCovTermInputSet.datetime_notarget.pcf: line 57, column 70
    ...
    // 'editable' attribute on DateInput (id=SideBySideDateTimeCovTermValue_Input) at SideBySideCovTermInputSet.datetime_notarget.pcf: line 51, column 39
    function editable_18 () : java.lang.Boolean {
      return covTermInfo.CovInfo.PeriodInfo.SxSEditable and covTermInfo.Editable
    }
    
    // 'editable' attribute on CheckBoxInput (id=covTermEnabledId_Input) at SideBySideCovTermInputSet.datetime_notarget.pcf: line 30, column 30
    ...
    // 'initialValue' attribute on Variable at SideBySideCovTermInputSet.datetime_notarget.pcf: line 21, column 23
    function initialValue_0 () : boolean {
      return covTermInfo.Visible
    }
    
    // 'onChange' attribute on PostOnChange at SideBySideCovTermInputSet.datetime_notarget.pcf: line 57, column 70
    function onChange_17 () : void {
      covTermInfo.CovInfo.coverageSelectionRefresh()
    }
    
    // 'onChange' attribute on PostOnChange at SideBySideCovTermInputSet.datetime_notarget.pcf: line 34, column 70
    function onChange_2 () : void {
      covTermInfo.CovInfo.coverageSelectionRefresh()
    }
    
    // 'tdClass' attribute on LayoutConfig at SideBySideCovTermInputSet.datetime_notarget.pcf: line 32, column 97
    function tdClass_1 () : java.lang.String {
      return "pc-sxs-col-" + (covTermInfo.CovInfo.PeriodInfo.ColumnIndex % 2)
    }
    
    // 'validationExpression' attribute on DateInput (id=SideBySideDateTimeCovTermValue_Input) at SideBySideCovTermInputSet.datetime_notarget.pcf: line 51, column 39
    ...
    // 'visible' attribute on TextInput (id=datetimeSpacer_Input) at SideBySideCovTermInputSet.datetime_notarget.pcf: line 41, column 31
    function visible_12 () : java.lang.Boolean {
      return !selectable
    }
    
    // 'visible' attribute on InputSet at SideBySideCovTermInputSet.datetime_notarget.pcf: line 23, column 27
    function visible_26 () : java.lang.Boolean {
      return isVisible
    }
    
    // 'visible' attribute on InputSetRef at SideBySideCovTermInputSet.datetime_notarget.pcf: line 62, column 29
    function visible_27 () : java.lang.Boolean {
      return !isVisible
    }
    
    // 'visible' attribute on CheckBoxInput (id=covTermEnabledId_Input) at SideBySideCovTermInputSet.datetime_notarget.pcf: line 30, column 30
