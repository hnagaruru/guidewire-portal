...
class AdditionalConditionsDVExpressions {
  ...
  public static class AdditionalConditionsDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'initialValue' attribute on Variable at AdditionalConditionsDV.pcf: line 23, column 51
    function initialValue_0 () : gw.api.productmodel.ClausePattern[] {
      return coverable == null ? {} : filteredConditions()
    }
    ...
    // 'sortBy' attribute on IteratorSort at AdditionalConditionsDV.pcf: line 38, column 28
    function sortBy_2 (pattern :  gw.api.productmodel.ClausePattern) : java.lang.Object {
      return pattern.Priority
    }
    
    // 'value' attribute on InputIterator (id=AddedConditionsIterator) at AdditionalConditionsDV.pcf: line 32, column 59
    function value_34 () : gw.api.productmodel.ClausePattern[] {
      return addedConditionsToShow
    }
    
    // 'visible' attribute on InputSet at AdditionalConditionsDV.pcf: line 26, column 54
    ...
    function filteredConditions() : ClausePattern[] {
      if (coverable == null) {
        return null
      }
    
      var policyConditions = includeExclude
          ? coverable.getConditionsInCategories(coverageCategories)
          : coverable.getConditionsNotInCategories(coverageCategories)
    
      var clausePatterns = policyConditions.map(\condition -> condition.Pattern)?.toTypedArray()
      return APDClauseHierarchyHelper.filterTopLevelClauses(coverable, clausePatterns).orderBy(\cond -> cond.Priority).toTypedArray()
    }
  ...
  public static class IteratorEntryExpressionsImpl extends AdditionalConditionsDVExpressionsImpl {
    ...
    // 'def' attribute on InputSetRef at AdditionalConditionsDV.pcf: line 41, column 38
    ...
    // 'mode' attribute on InputSetRef at AdditionalConditionsDV.pcf: line 41, column 38
