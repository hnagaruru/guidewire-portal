...
@Export
class ${coverable.QualifiedName}ScheduleExclItemCoverableAdapterBase extends AbstractScheduledItemAdapter {
  var _owner : ${coverable.QualifiedName}ScheduleExclItem as readonly Owner

  construct(item : entity.${coverable.QualifiedName}ScheduleExclItem) {
    _owner = item
  }
  ...
  override function addExclusion(excl : Exclusion) {
    _owner.ScheduledItemClause = excl as entity.${coverable.QualifiedName}SchExclItemExcl
  }
