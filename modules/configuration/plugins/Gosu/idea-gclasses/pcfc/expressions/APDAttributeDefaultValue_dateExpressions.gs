...
class APDAttributeDefaultValue_dateExpressions {
  ...
  public static class APDAttributeDefaultValueExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on TextCell (id=value_Cell) at APDAttributeDefaultValue.date.pcf: line 33, column 25
    ...
    // 'initialValue' attribute on Variable at APDAttributeDefaultValue.date.pcf: line 27, column 32
    function initialValue_0 () : APDAttributeRule {
      return attribute.getEditionRule(edition, ruleType)
    }
    
    // 'outputConversion' attribute on TextCell (id=value_Cell) at APDAttributeDefaultValue.date.pcf: line 33, column 25
    function outputConversion_3 (VALUE :  Date) : java.lang.String {
      return VALUE.ShortFormat
    }
    
    // 'value' attribute on TextCell (id=value_Cell) at APDAttributeDefaultValue.date.pcf: line 33, column 25
