...
class CovTermInputSet_shorttextExpressions {
  ...
  public static class CovTermInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=StringTermInput_Input) at CovTermInputSet.shorttext.pcf: line 38, column 82
    function defaultSetter_8 (__VALUE_TO_SET :  java.lang.Object) : void {
      (term as gw.api.domain.covterm.GenericCovTerm<String>).Value = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'disablePostOnEnter' attribute on PostOnChange at CovTermInputSet.shorttext.pcf: line 42, column 86
    ...
    // 'editable' attribute on InputSet (id=CovTermInputSet) at CovTermInputSet.shorttext.pcf: line 9, column 25
    function editable_12 () : java.lang.Boolean {
      return isEditable
    }
    
    // 'initialValue' attribute on Variable at CovTermInputSet.shorttext.pcf: line 22, column 25
    function initialValue_0 () : Coverable {
      return term.Clause.OwningCoverable
    }
    
    // 'initialValue' attribute on Variable at CovTermInputSet.shorttext.pcf: line 27, column 23
    function initialValue_1 () : boolean {
      return gw.web.rules.APDRulesHelper.isVisible(coverable, term.Pattern)
    }
    
    // 'initialValue' attribute on Variable at CovTermInputSet.shorttext.pcf: line 32, column 23
    function initialValue_2 () : boolean {
      return gw.web.rules.APDRulesHelper.isEditable(coverable, term.Pattern)
    }
    
    // 'label' attribute on TextInput (id=StringTermInput_Input) at CovTermInputSet.shorttext.pcf: line 38, column 82
    function label_5 () : java.lang.Object {
      return term.Pattern.DisplayName
    }
    
    // 'onChange' attribute on PostOnChange at CovTermInputSet.shorttext.pcf: line 42, column 86
    function onChange_4 () : void {
      gw.web.rules.APDRulesHelper.onChange(coverable, jobWizardHelper)
    }
    
    // 'required' attribute on TextInput (id=StringTermInput_Input) at CovTermInputSet.shorttext.pcf: line 38, column 82
    ...
    // 'visible' attribute on InputSet (id=CovTermInputSet) at CovTermInputSet.shorttext.pcf: line 9, column 25
